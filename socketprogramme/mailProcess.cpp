...
//int main() {
//    std::string clientId = "226182677713-8e6sumgkj2do1m0lbe4b0dbr2f4671hu.apps.googleusercontent.com";
//    std::string clientSecret = "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";
//    std::string code;
...
//        "scope=" + scope +
//        "&access_type=offline&redirect_uri=" + redirectUri +
//        "&response_type=code&client_id=" + clientId;
//
//    std::cout << "Please visit the following URL to authorize the application: \n" << authUrl << std::endl;
...
//         std::string ans = readGmail(accessToken);
//         std::cout << "The task for Server: " << ans;
//         Sleep(3000);*/
//        std::cout << "1.Doc mail\n";
//        std::cout << "2.Gui mail\n";
//        int lc;
...
//        else {
//            accessToken = refreshAccessToken(refreshtoken, clientId, clientSecret);
//            sendGmail(accessToken, "ttqminh2005@gmail.com", "tranminhttnt2005@gmail.com", "", "Hello fuck");
//        }
//    }
//    return 0;
//}
